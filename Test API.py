...
def send_answers(data, activity):
    response = requests.post(f'http://127.0.0.1:5000/alcohol/activity/{activity}',
                             headers={'Accept': 'application/json',
...
def first_activity():
    ...
    return print(send_answers(data, 1))
...
def second_activity():
    ...
    return print(send_answers(data, 2))
...
def third_activity():
    ...
    return print(send_answers(data, 3))
